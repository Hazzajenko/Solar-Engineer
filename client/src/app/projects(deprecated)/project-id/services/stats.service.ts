...
import { selectAllStrings } from '../../store(deprecated)/strings/strings.selectors'
...
import { selectAllTrackers } from '../../store(deprecated)/trackers/trackers.selectors'
import { InverterModel } from '../../models/deprecated-for-now/inverter.model'
import { selectAllInverters } from '../../store(deprecated)/inverters/inverters.selectors'
...
export class StatsService {
  inverters$: Observable<InverterModel[]> = this.store.select(selectAllInverters)
