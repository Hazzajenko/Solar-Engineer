...
import { SelectedStateActions } from '../project-id/services/store/selected/selected.actions'
import { GridStateActions } from '../project-id/services/store/grid/grid.actions'
...
} from '../project-id/services/store/selected/selected.selectors'
import { BlocksStateActions } from '../project-id/services/store/blocks/blocks.actions'
import { MultiActions } from '../project-id/services/store/multi-create/multi.actions'
...
export class GridLayoutDirective {
  ...
  async keyEvent(event: KeyboardEvent) {
    ...
    /*    if (event.key === 'Escape') {
          this.store(deprecated).dispatch(LinksStateActions.clearLinkState())
          this.store(deprecated).dispatch(SelectedStateActions.clearSelectedState())
