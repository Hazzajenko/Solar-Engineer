...
// import { Store } from '@ngrx/store(deprecated)';
// import { AppState } from '../../store(deprecated)/app.state';
//
//
//
...
//   constructor(private http: HttpClient, private store(deprecated): Store<AppState>) {}
// }
//
// /*
//   initTreeNode(projectId: number) {
//     combineLatest([
//       this.store(deprecated).select(
...
//         });
//         this.store(deprecated).dispatch(addTreeNode({ treeNode: inverterNode }));
//       });
//     });
//   }
//
