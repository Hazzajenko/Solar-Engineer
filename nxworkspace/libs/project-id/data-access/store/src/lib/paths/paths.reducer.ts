...
import { PanelLinkPathModel } from '@shared/data-access/models'
...
export interface PathsState extends EntityState<PanelLinkPathModel> {
  loaded: boolean
  error?: string | null
}

export const pathsAdapter: EntityAdapter<PanelLinkPathModel> = createEntityAdapter<PanelLinkPathModel>()
