...
import { SelectStringComponent } from '../dialogs/src/lib/select-string/select-string.component'
import { CreateStringComponent } from '../dialogs/src/lib/create-string/create-string.component'
...
import { ViewStringsDialog } from '../dialogs/src/lib/view-strings-dialog/view-strings.dialog'
