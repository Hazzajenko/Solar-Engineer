...
export class TrackersService {
  ...
  getTrackersByProjectId(projectId: number): Promise<TrackersEnvelope> {
    return new Promise<TrackersEnvelope>((resolve, reject) =>
      this.http
        .get<TrackersEnvelope>(environment.apiUrl + `/projects/${projectId}/trackers`)
        .subscribe({
          next: (envelope) => {
  ...
  createTrackers(projectId: number, inverterId: number): Promise<TrackersEnvelope> {
    ...
    return new Promise<TrackersEnvelope>((resolve, reject) =>
      this.http
        .post<TrackersEnvelope>(environment.apiUrl + `/projects/${projectId}/${inverterId}`, {})
        .subscribe({
          next: (envelope) => {
            this.store.dispatch(addTrackers({ trackers: envelope.trackers }))
            resolve(envelope)
  ...
  deleteTracker(projectId: number, trackerId: number): Promise<TrackerEnvelope> {
    return new Promise<TrackerEnvelope>((resolve, reject) =>
      this.http
        .delete<TrackerEnvelope>(`${environment.apiUrl}/projects/${projectId}/trackers`, {
          body: {
            id: trackerId,
          },
        })
