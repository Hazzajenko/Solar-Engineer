...
export const sortByInverterName = (a: InverterModel, b: InverterModel): number =>
  a.name.localeCompare(b.name)

export const inverterAdapter: EntityAdapter<InverterModel> = createEntityAdapter<InverterModel>({
...
export const invertersReducer = createReducer(
  ...
  on(InverterActions.addInverter, (state, { inverter }) => inverterAdapter.addOne(inverter, state)),
...
export const { selectIds, selectEntities, selectAll } = inverterAdapter.getSelectors()
