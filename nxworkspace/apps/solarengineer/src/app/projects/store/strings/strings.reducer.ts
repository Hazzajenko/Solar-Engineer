...
export const stringAdapter: EntityAdapter<StringModel> = createEntityAdapter<StringModel>({
...
export const { selectIds, selectEntities, selectAll } = stringAdapter.getSelectors()
