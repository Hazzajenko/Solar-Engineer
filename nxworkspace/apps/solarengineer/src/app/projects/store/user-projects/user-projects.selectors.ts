...
export const selectAllProjectMembers = createSelector(selectUserProjectsState, State.selectAll)
...
export const selectProjectMembersByProjectIdRouteParams = createSelector(
  ...
  (projectMembers, { projectId }) =>
    projectMembers.filter((projectMember) => projectMember.projectId === Number(projectId)),
)
