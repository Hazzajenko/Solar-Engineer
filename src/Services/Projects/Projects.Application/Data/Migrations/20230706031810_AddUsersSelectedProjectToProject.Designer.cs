...
namespace Projects.Application.Data.Migrations
{
    ...
    [Migration("20230706031810_AddUsersSelectedProjectToProject")]
    partial class AddUsersSelectedProjectToProject
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Projects.Domain.Entities.Project", b =>
                {
                    ...
                    b.Property<Guid>("UndefinedStringId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                        .HasDefaultValueSql("uuid_generate_v4()");
            ...
            modelBuilder.Entity("Projects.Domain.Entities.ProjectUser", b =>
                {
                    b.HasOne("Projects.Domain.Entities.Project", "SelectedProject")
                        .WithMany("UsersSelectedProject")
            ...
            modelBuilder.Entity("Projects.Domain.Entities.Project", b =>
                {
                    ...
                    b.Navigation("UsersSelectedProject");
                });
