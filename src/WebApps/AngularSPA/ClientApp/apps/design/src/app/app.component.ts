...
export class AppComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    /*    this.http
          .get('http://localhost:5001/users/grpc/0d84dbc0-da93-4515-a912-ac5b6e0009b4', {
   ...
   /*  this.http
      .get('/users/grpc/0d84dbc0-da93-4515-a912-ac5b6e0009b4', {
        withCredentials: true,
      })
      // .pipe(catchError(() => EMPTY))
      .subscribe((res) => {
    ...
    this.http
      .get('/WeatherForecast', { withCredentials: true })
      // .pipe(catchError(() => EMPTY))
      .subscribe((res) => {
        console.log(res)
