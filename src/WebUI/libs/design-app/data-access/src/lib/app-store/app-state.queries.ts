...
import { selectAppStateState, selectContextMenuState } from './app-state.selectors'
...
export class AppStateQueries {
	...
	/*	private readonly _pointer$ = this._store.pipe(select(selectPointerState))
	 private readonly _pointer = toSignal(this._pointer$, { initialValue: initialAppState.hoveringOverEntityState })
