...
@Component({
	selector:       'app-canvas-app-settings', standalone: true, imports: [
		NgForOf,
	], templateUrl: './canvas-app-settings.component.html', styles: [], changeDetection: ChangeDetectionStrategy.OnPush,
})
