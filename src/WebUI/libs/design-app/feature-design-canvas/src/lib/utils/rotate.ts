...
import { AngleRadians, CanvasEntity, drawSelectionBoxBoundsCtxFnWithTranslateRotate, getAngleInRadiansBetweenTwoPoints, rotatePointOffPivot, SizeByType, TransformedPoint, TrigonometricBounds } from '@design-app/feature-design-canvas';
...
export const rotate = (
	...
	y2: number,
	angle: number,
): [number, number] => // 𝑎′𝑥=(𝑎𝑥−𝑐𝑥)cos𝜃−(𝑎𝑦−𝑐𝑦)sin𝜃+𝑐𝑥
