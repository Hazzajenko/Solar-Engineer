...
@Component({
  selector:        'app-design-panel-menu[panelId][selected]',
  templateUrl:     './design-panel-menu.component.html',
  styles:          [],
...
export class DesignPanelMenuComponent {
  public store = inject(DesignPanelStore)
