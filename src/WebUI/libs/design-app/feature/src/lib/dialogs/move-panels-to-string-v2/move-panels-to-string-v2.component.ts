...
@Component({
	selector: 'dialog-move-panels-to-string-v2',
	templateUrl: 'move-panels-to-string-v2.component.html',
	standalone: true,
	imports: [AsyncPipe, NgForOf, NgIf, MatDialogModule, MatButtonModule],
})
export class MovePanelsToStringV2Component implements OnInit, AfterViewInit {
