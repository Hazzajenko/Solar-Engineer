...
@Component({
	selector: 'dialog-move-panels-to-string-v3',
	templateUrl: 'move-panels-to-string-v3.component.html',
	standalone: true,
	imports: [AsyncPipe, NgForOf, NgIf, MatDialogModule, MatButtonModule],
})
export class MovePanelsToStringV3Component implements OnInit, AfterViewInit {
