...
import { CONTEXT_MENU_COMPONENT, DIALOG_COMPONENT, injectUiStore } from '@overlays/ui-store/data-access'
...
import { AssertIsProjectPipe, FilterProjectMembersByOnlinePipe, GetProjectByIdPipe } from '@entities/utils'
import { ProjectDetailsViewComponent } from '../shared'
...
import { selectAllWebProjects } from '../index'
...
@Component({
	...
	templateUrl: './side-ui-projects-list-view.component.html',
	styles: [
		`
			/* width */
			::-webkit-scrollbar {
...
export class SideUiProjectsListViewComponent {
