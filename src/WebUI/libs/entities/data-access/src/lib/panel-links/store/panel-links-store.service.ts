/*
 ...
 import { PanelLinkId, PanelLinkModel, PanelLinkRequest, Polarity } from '@entities/shared'
 ...
 get allPanelLinks() {
 return this._store.selectSignal(selectAllPanelLinks)
 ...
 deletePanelLink(id: PanelLinkId) {
 this._store.dispatch(PanelLinksActions.deletePanelLink({ panelLinkId: id }))
 }

 deleteManyPanelLinks(ids: PanelLinkId[]) {
 this._store.dispatch(PanelLinksActions.deleteManyPanelLinks({ panelLinkIds: ids }))
 }
