/*
 ...
 return this.state.singleSelectedPanelId
 }
 ...
 return this.state.multipleSelectedPanelIds
 }
 ...
 this._store.dispatch(SelectedActions.removePanelsFromMultiSelect({ entityIds }))
 }
