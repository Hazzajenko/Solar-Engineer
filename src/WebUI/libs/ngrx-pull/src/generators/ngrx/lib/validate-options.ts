...
export function validateOptions(tree: Tree, options: NgRxGeneratorOptions): void {
	...
	const intendedNgRxVersionForAngularMajor = getPkgVersionForAngularMajorVersion(
		'ngrxVersion',
