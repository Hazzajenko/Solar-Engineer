import {
	selectAllPanels,
	selectPanelEntityById,
	selectPanelsByIdArray,
	selectPanelsEntities,
} from '../../store/panels.selectors'
...
export class PanelsQueries {
	...
	private readonly _panelEntities$: Observable<Dictionary<PanelModel>> = this._store.pipe(
		select(selectPanelsEntities),
	)
