...
export const StringsActions = createActionGroup({
  ...
  events: {
    ...
    'Create String With Panels': props<{ string: StringModel; panelIds: string[] }>(),
    'Add String Without Signalr': props<{ string: StringModel }>(),
    'Add Many Strings': props<{ strings: StringModel[] }>(),
    'Update String': props<{ update: UpdateStr<StringModel> }>(),
    'Update String Without Signalr': props<{ update: UpdateStr<StringModel> }>(),
    // 'Update String': props<{ update: Update<StringModel> }>(),
    'Update Many Strings': props<{ updates: UpdateStr<StringModel>[] }>(),
