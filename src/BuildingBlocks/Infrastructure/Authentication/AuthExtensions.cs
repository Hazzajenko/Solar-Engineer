...
public static class AuthExtensions
{
    ...
    public static async Task<JwtSettings> GetJwtSettings(
        this ConfigurationManager config,
        IWebHostEnvironment environment
    )
    {
        if (environment.IsDevelopment())
            return config.GetSection("Jwt").Get<JwtSettings>()
    ...
    public static async Task<SymmetricSecurityKey> GetSymmetricSecurityKey(
        this IWebHostEnvironment environment,
        IConfiguration config
    )
    {
