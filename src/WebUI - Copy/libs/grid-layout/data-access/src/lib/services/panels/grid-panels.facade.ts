...
export class GridPanelsFacade {
  ...
  isSelectedNegativeTo$(id: string) {
    return this.store.select(SelectedSelectors.selectSelectedNegativeTo)
      .pipe(
  ...
  isSelectedPositiveTo$(id: string) {
    return this.store.select(SelectedSelectors.selectSelectedPositiveTo)
      .pipe(
  ...
  isPanelToJoin$(id: string) {
    return this.store.select(LinksSelectors.selectToLinkIdWithType)
      .pipe(
        map(({ type, toLinkId }) => {
