...
export const selectPosXY = createSelector(selectUiState, (state: UiState) => state.posXY)

export const selectMouseXY = createSelector(selectUiState, (state: UiState) => state.mouseXY)
...
export const selectGridLayoutZoom = createSelector(
  selectUiState,
  (state: UiState) => state.gridLayoutZoom,
)
