...
import { GridSelectedFacade, GridStringsEventService, GridStringsFacade } from '@grid-layout/data-access'
                           ...
                           <ng-container *cdkVirtualFor='let string of strings$ | async'>
                             ...
                             <ng-container *ngIf='showString === string.id'>
                               <div class='container__button-menu'>
                                 <button (click)='selectString(string)'
                                         mat-icon-button>
                                 ...
                                 <button (click)='deleteString(string)'
                                         mat-icon-button>
