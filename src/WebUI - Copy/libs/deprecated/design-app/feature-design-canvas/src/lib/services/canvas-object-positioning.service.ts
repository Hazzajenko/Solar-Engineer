/*
 ...
 import { CanvasSelectedService } from './canvas-selected/canvas-selected.service'
 ...
 toMove: {
 singleToMove: {
 id: entityOnMouseDown.id, type: entityOnMouseDown.type, location, angle,
 ...
 toMove: {
 multipleToMove: {
 ids: multiToMoveIds, startPoint: multiToMoveStart, offset, entities: updates,
 },
 },
 })
 ...
 toRotate: {
 singleToRotate: {
 ...singleToRotate, startPoint: currentPoint, adjustedAngle: angle,
 },
 },
 })
 this._render.drawCanvas()
 ...
 return {
 id: entity.id, adjustedLocation: getPos,
 ...
 toRotate: {
 multipleToRotate: {
 ...multipleToRotate, adjustedAngle, entities,
 },
 },
 })
 ...
 this._state.updateState({
 toRotate: {
 ids: [], multipleToRotate: undefined,
 },
 })
 // this._state.entity.
 }
 ...
 this._state.updateState({
 toRotate: {
 singleToRotate: undefined, singleRotateMode: false,
 },
 })
 }
 ...
 getAllAvailableEntitySpotsBetweenTwoPoints(point1: TransformedPoint, point2: TransformedPoint) {
 ...
 vacant: true, x: point1.x + startingPoint.x + i * adjustedWidth, y: point1.y + startingPoint.y + a * adjustedHeight,
 }
 existingEntities.forEach((entity) => {
 const firstSpot = {
 x: spot.x - entity.width / 2, y: spot.y - entity.height / 2,
 }
 const secondSpot = {
 x: spot.x + entity.width + entity.width / 2, y: spot.y + entity.width + entity.height / 2,
 }
 ...
 isEntityInsideByDirection(entity: CanvasEntity, direction: DiagonalDirection, point1: TransformedPoint, point2: TransformedPoint) {
 // const start
 ...
 isEntityInsideTwoPoints(entity: CanvasEntity, point1: Point, point2: Point) {
 ...
 getInsideCheckPointsByDirection(direction: DiagonalDirection) {
 switch (direction) {
 case DIAGONAL_DIRECTION.BottomLeftToTopRight:
 return {}
 case DIAGONAL_DIRECTION.TopLeftToBottomRight:
 ...
 getAllElementsBetweenTwoPoints(point1: TransformedPoint, point2: TransformedPoint) {
