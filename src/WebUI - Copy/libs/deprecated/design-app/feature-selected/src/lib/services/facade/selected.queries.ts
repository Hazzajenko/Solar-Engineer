...
import { SelectedPanelState } from 'deprecated/design-app/feature-panel'
import {
	selectMultiSelectedEntities,
	selectMultiSelectedEntitiesOfType,
	selectNearbyEntitiesOnAxis,
	selectSelectedPanelState,
	selectSingleAndMultiSelectedEntities,
	selectSingleSelectedEntity,
} from 'deprecated/design-app/feature-selected'
...
export class SelectedQueries {
	...
	}> = this._store.pipe(select(selectSingleAndMultiSelectedEntities))
