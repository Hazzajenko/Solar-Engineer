...
namespace dotnetapi.Data.Migrations
{
    ...
    [Migration("20230117094449_EditNotification")]
            ...
            modelBuilder.Entity("dotnetapi.Models.Entities.Notification", b =>
                {
                    ...
                    b.HasIndex("AppUserId", "AppUserFriendId")
                        .IsUnique();
            ...
            modelBuilder.Entity("dotnetapi.Models.Entities.Notification", b =>
                {
                    ...
                    b.HasOne("dotnetapi.Models.Entities.AppUserFriend", "AppUserFriend")
                        .WithOne("Notification")
                        .HasForeignKey("dotnetapi.Models.Entities.Notification", "AppUserId", "AppUserFriendId");
