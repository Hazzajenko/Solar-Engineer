...
public sealed record GetAppUserFriendQuery(AppUser AppUser, AppUser FriendUser)
    : IRequest<AppUserFriend?>;

public class GetAppUserFriendHandler : IRequestHandler<GetAppUserFriendQuery, AppUserFriend?>
{
    ...
    public async ValueTask<AppUserFriend?> Handle(
        GetAppUserFriendQuery request,
