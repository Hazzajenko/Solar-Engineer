...
public sealed record DeleteAppUserFriendQuery(AppUserFriend AppUserFriend) : IRequest<bool>;

public class DeleteAppUserFriendHandler : IRequestHandler<DeleteAppUserFriendQuery, bool>
{
    ...
    public async ValueTask<bool> Handle(DeleteAppUserFriendQuery request, CancellationToken cT)
    {
